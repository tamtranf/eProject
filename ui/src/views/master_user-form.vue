...
export default {
  name: 'master_user-form',
  data() {
    return {
      local_fields_ref_a: false,
      local_fields_ref_b: false,
      api_name: 'master_user',
      name: 'MasterUserForm',
    };
  },
  routes: [
    {
      path: '/master_user-form/:seq_id',
      name: 'master_user-form',
    },
    {
      path: '/master_user-form',
      name: 'master_user-form-undefined',
    },
  ],
  ...
  computed: {
    ...
    formFieldsSideA() {
      ...
      if (this.local_fields_ref_a === false) {
        this.local_fields_ref_a = this.setFormDefaultFields(['user_name', 'full_name', 'last_login'], fields);
      }
