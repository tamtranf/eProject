...
export default {
  name: 'master_user_permission-form',
  data() {
    return {
      local_fields_ref_a: false,
      local_fields_ref_b: false,
      api_name: 'master_user_permission',
      name: 'MasterUserPermissionForm',
    };
  },
  routes: [
    {
      path: '/master_user_permission-form/:seq_id',
      name: 'master_user_permission-form',
    },
    {
      path: '/master_user_permission-form',
      name: 'master_user_permission-form-undefined',
    },
  ],
  ...
  computed: {
    ...
    formFieldsSideA() {
      ...
      if (this.local_fields_ref_a === false) {
        this.local_fields_ref_a = this.setFormDefaultFields(['user_name'], fields);
      }
