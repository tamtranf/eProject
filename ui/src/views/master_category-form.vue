...
export default {
  ...
  routes: [
    {
      path: '/master_category-form/:seq_id',
      name: 'master_category-form',
    },
    {
      path: '/master_category-form',
      name: 'master_category-form-undefined',
    },
  ],
  ...
  computed: {
    ...
    formFieldsSideA() {
      ...
      if (this.local_fields_ref_a === false) {
        this.local_fields_ref_a = this.setFormDefaultFields(['category_name'], fields);
      }
