...
import { fields } from '../../../api/rules/fields_master_entity';
...
export default {
  ...
  data() {
    return {
      ...
      api_name: 'master_entity',
      name: 'MasterEntityForm',
    };
  },
  routes: [
    {
      path: '/master_entity-form/:seq_id',
      name: 'master_entity-form',
    },
    {
      path: '/master_entity-form',
      name: 'master_entity-form-undefined',
    },
  ],
  ...
  computed: {
    ...
    formFieldsSideA() {
      ...
      if (this.local_fields_ref_a === false) {
        this.local_fields_ref_a = this.setFormDefaultFields(['entity_code'], fields);
      }
