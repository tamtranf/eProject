...
import { fields } from '../../../api/rules/fields_master_maker';

export default {
  name: 'master_maker-form',
  data() {
    return {
      local_fields_ref_a: false,
      local_fields_ref_b: false,
      api_name: 'master_maker',
      name: 'MasterMakerForm',
    };
  },
  routes: [
    {
      path: '/master_maker-form/:seq_id',
      name: 'master_maker-form',
    },
    {
      path: '/master_maker-form',
      name: 'master_maker-form-undefined',
    },
  ],
  ...
  computed: {
    ...
    formFieldsSideA() {
      ...
      if (this.local_fields_ref_a === false) {
        this.local_fields_ref_a = this.setFormDefaultFields(['maker_name'], fields);
      }
