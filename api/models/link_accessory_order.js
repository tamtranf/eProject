...
const debug = require('debug')('LinkAccessoryOrder');
const local_fields = require('../rules/fields_link_accessory_order');
...
class LinkAccessoryOrder extends base_model {
  constructor() {
    super();
...
module.exports = new LinkAccessoryOrder();
